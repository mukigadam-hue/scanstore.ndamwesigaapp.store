...
const showStartupFallback = (message: string) => {
  if (!rootEl) return;
  rootEl.innerHTML = `
    <div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;background:#1a1207;color:#f5e6c4;font-family:system-ui,-apple-system,sans-serif;text-align:center;">
      <div style="max-width:360px;">
        ...
        <p style="font-size:14px;opacity:0.85;margin-bottom:20px;">${message}</p>
...
try {
  ...
  showStartupFallback("Your device may need an update. Please reload to try again.");
}
